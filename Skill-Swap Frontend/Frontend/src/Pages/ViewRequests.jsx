...
//   const submitBarterRequest = async (useExistingPost = false, existingPostId = null) => {
...
//       if (useExistingPost && existingPostId) {
//         requestData.senderSkillPostId = existingPostId
//       } else {
...
//                   <button
//                     onClick={() => submitBarterRequest(false)}
//                     disabled={sendingRequest[selectedPost._id]}
//                     className="w-full mt-6 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2"
//                   >
...
//                     )}
//                     <span>
//                       {sendingRequest[selectedPost._id] ? "Sending Request..." : "Send Request with New Skill Post"}
//                     </span>
//                   </button>
//                 </div>
