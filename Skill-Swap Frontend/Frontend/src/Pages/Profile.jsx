...
import { User, Mail, Edit3, Save, X, Plus, Eye, EyeOff, Calendar, Clock, Star, Award, Shield, CheckCircle, AlertCircle, LogOut, LogIn, ArrowLeft, Loader } from 'lucide-react'
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12 px-8 md:px-16 rounded-b-3xl shadow-lg">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg opacity-90">Manage your skills and availability</p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 mt-10">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-12 text-center">
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-md mx-auto">
              You need to be logged in to view and manage your profile. Please sign in to continue.
            </p>
            <Link
              to="/login-signup"
