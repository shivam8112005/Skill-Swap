...
import { useState, useEffect } from "react"
import { Link } from "react-router-dom"
import { Send, Activity, FileText, Users, Star, Calendar, AlertCircle, LogIn, ArrowLeft, Loader, CheckCircle, RefreshCw } from 'lucide-react'
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div className="pt-6 border-t border-gray-200">
              {/* Success Message */}
              {success && (
                <div className="bg-green-50 border border-green-200 rounded-xl p-6 flex items-center space-x-3 mb-6">
                  <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0" />
                  <div>
                    <p className="text-green-800 font-semibold">Skill post created successfully!</p>
                    <p className="text-green-700 text-sm mt-1">
