...
//               <Button
//                 size="lg"
//                 className="bg-white text-blue-700 hover:bg-blue-50 font-semibold px-8 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
//               >
...
//                 variant="outline"
//                 size="lg"
//                 className="border-white/30 text-white hover:bg-white/10 font-semibold px-8 py-3 rounded-xl backdrop-blur-sm bg-transparent"
//               >
//                 Explore Skills
...
//             <Card
//               key={index}
//               className="text-center shadow-lg border-0 bg-gradient-to-br from-white to-blue-50/50 hover:shadow-xl transition-all duration-300"
//             >
...
//               Popular Skills
//             </CardTitle>
//             <p className="text-gray-600">Most requested skills on our platform</p>
//           </CardHeader>
//           <CardContent>
...
//                   key={index}
//                   variant="outline"
//                   className="px-4 py-2 text-sm font-medium bg-white hover:bg-green-50 hover:border-green-300 cursor-pointer transition-all duration-300"
//                 >
//                   {skill}
//                 </Badge>
//               ))}
...
//             <CardTitle className="text-3xl font-bold text-gray-800 mb-4">How It Works</CardTitle>
...
//         {/* Testimonials */}
//         <Card className="shadow-xl border-0 bg-gradient-to-br from-white to-yellow-50/50">
//           <CardHeader className="text-center pb-8">
...
//               <Button
//                 size="lg"
//                 className="bg-white text-blue-700 hover:bg-blue-50 font-semibold px-8 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
//               >
//                 <Zap className="w-5 h-5 mr-2" />
//                 Get Started Now
//               </Button>
...
//                 <Textarea
//                   rows={6}
//                   className="w-full border-gray-200 rounded-xl focus:border-blue-500 focus:ring-blue-500 resize-none"
//                   placeholder="Enter text to summarize and generate quiz from..."
//                 />
//               </div>

//               <div className="flex space-x-3">
//                 <Button className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
//                   <Sparkles className="w-4 h-4 mr-2" />
//                   Generate Summary
//                 </Button>
//                 <Button className="flex-1 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
